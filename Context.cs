...
public class Context : DbContext
{
    ...
    private void AirplaneConfigure(EntityTypeBuilder<Airplane> builder)
    {
        ...
        {
            new Airplane("МС-21",1, true,910, 6400)
            {id = 1 },
            new Airplane("Ту-214",2, true,850,7200)
            {id = 2},
            new Airplane("Boeing 737 MAX",3,true,835,6570)
            {id = 3 },
            new Airplane("Boeing 777X",2,true,900,13500)
            {id = 4 },
        };
